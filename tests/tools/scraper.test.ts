...
describe("scraper tool", () => {
  ...
  describe("HTML to Markdown conversion", () => {
    ...
    it("should convert code blocks", async () => {
      mockFetch.mockResolvedValueOnce({
        ...
        headers: new Map([["content-type", "text/html"]]),
        text: async () =>
          "<code>inline</code> and <pre><code>block</code></pre>",
      });
    ...
    it("should strip script and style tags", async () => {
      mockFetch.mockResolvedValueOnce({
        ...
        headers: new Map([["content-type", "text/html"]]),
        text: async () =>
          '<script>alert("xss")</script><style>.red{color:red}</style><p>Safe</p>',
      });
  ...
  describe("input validation", () => {
    it("should require valid URL", () => {
      expect(() =>
        inputSchema.parse({ url: "not-a-url", convertToMarkdown: true }),
      ).toThrow();
    });
