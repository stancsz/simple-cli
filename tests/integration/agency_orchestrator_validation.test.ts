...
// Mock fs to avoid creating actual child agency folders during tests, and avoid breaking LLM config loader
...
// Mock LLM correctly for vitest as per memory instructions
vi.mock("../../src/llm.js", () => {
    class MockLLM {
        async generate() { return "Mocked expanded context"; }
