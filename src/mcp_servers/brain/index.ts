    ...
    this.server.tool(
      ...
      async ({ query, company }) => {
        try {
          ...
          return {
            content: [{ type: "text", text: `Error querying graph: ${error.message}` }],
            isError: true,
          };
        }
      }
    ...
    this.server.tool(
      ...
      async ({ operation, args, company }) => {
        try {
          ...
          return {
            content: [{ type: "text", text: `Error updating graph: ${error.message}` }],
            isError: true,
          };
        }
      }
    ...
    this.server.tool(
      ...
      async ({ name }) => {
        try {
          ...
          return {
            content: [{ type: "text", text: `Error retrieving SOP: ${error.message}` }],
            isError: true,
          };
        }
      }
    ...
    this.server.tool(
      ...
      async ({ taskId, task_type, agent_used, outcome, summary, artifacts, company }) => {
        try {
          ...
          return {
            content: [{ type: "text", text: `Error logging experience: ${error.message}` }],
            isError: true,
          };
        }
      }
    ...
    this.server.tool(
      ...
      async ({ task_type, query, company }) => {
        try {
          ...
          return {
            content: [{ type: "text", text: `Error recalling delegation patterns: ${error.message}` }],
            isError: true,
          };
        }
      }
